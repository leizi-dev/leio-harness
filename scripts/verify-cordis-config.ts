...
const CHOOSER_PACKAGE = '@leio-ai/leio-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@leio-ai/leio-host-directory-picker-native',
  '@leio-ai/leio-host-directory-picker-browse',
  '@leio-ai/leio-client-ui-directory-picker-browse',
  '@leio-ai/leio-client-ui-directory-picker-native',
]
