...
import type { CordisCatalogModel, ServiceMethodEntry } from '@leio-ai/leio-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@leio-ai/leio-tool-cordis/api-catalog', '@leio-ai/leio-cordis-client-runner/client/api-catalog')
