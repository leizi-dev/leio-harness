...
import type { ToolSchema } from '@leio-ai/leio-llm'
import AgentRegistry from '@leio-ai/leio-agent'
import type { Agent } from '@leio-ai/leio-agent'
import { createScope } from '@leio-ai/leio-scope'
import SessionStore, { SessionId } from '@leio-ai/leio-session'
import SessionProjectionRegistry from '@leio-ai/leio-session-projection'
import SqliteSessionQueryEngine from '@leio-ai/leio-session-query-sqlite'
import GoalService from '@leio-ai/leio-goal'
import SystemPrompt from '@leio-ai/leio-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@leio-ai/leio-tools'
import LocalBashExecutor from '@leio-ai/leio-bash-local'
import * as BashEnvPlugin from '@leio-ai/leio-shell-env'
import { PwshLocalExecutor } from '@leio-ai/leio-pwsh-local'
import LocalSubprocessRuntime from '@leio-ai/leio-subprocess-local'
import LocalFileSystem from '@leio-ai/leio-fs-local'
import { AttachmentStore } from '@leio-ai/leio-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@leio-ai/leio-attachment'
import UserQuestionService from '@leio-ai/leio-user-questions'
import PlanModeController from '@leio-ai/leio-plan-mode'
import WebRuntime from '@leio-ai/leio-web'
import * as WebSearchExa from '@leio-ai/leio-web-search-exa'
import * as WebFetchLocal from '@leio-ai/leio-web-fetch-http'
import SubagentRuntime from '@leio-ai/leio-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@leio-ai/leio-subagent'
import * as ToolSubagentControl from '@leio-ai/leio-tool-subagent-control'
import * as ToolSubagentListAgents from '@leio-ai/leio-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@leio-ai/leio-tool-subagent-report'
import SkillRegistry from '@leio-ai/leio-skill'
import * as SkillFileSystem from '@leio-ai/leio-skill-filesystem'
import LocalJobRegistry from '@leio-ai/leio-jobs-local'
import * as ToolAskUser from '@leio-ai/leio-tool-ask-user'
import * as ToolBash from '@leio-ai/leio-tool-bash'
import * as ToolPwsh from '@leio-ai/leio-tool-pwsh'
import * as ToolBashPersistent from '@leio-ai/leio-tool-bash-persistent'
import CordisHostRunner from '@leio-ai/leio-cordis-host-runner'
import * as ToolCordis from '@leio-ai/leio-tool-cordis'
import * as ToolFs from '@leio-ai/leio-tool-fs'
import * as ToolFsSearch from '@leio-ai/leio-tool-fs-search'
import * as ToolStrReplaceEditor from '@leio-ai/leio-tool-str-replace-editor'
import TerminalSessionService from '@leio-ai/leio-terminal'
import * as ToolPty from '@leio-ai/leio-tool-terminal'
import * as ToolGoal from '@leio-ai/leio-tool-goal'
import * as ToolSchedule from '@leio-ai/leio-schedule'
import Lsp from '@leio-ai/leio-lsp'
import * as ToolLsp from '@leio-ai/leio-tool-lsp'
import * as ToolSkill from '@leio-ai/leio-tool-skill'
import * as ToolSessionQuery from '@leio-ai/leio-tool-session-query'
import * as ToolTasks from '@leio-ai/leio-tool-jobs'
import * as ToolTodo from '@leio-ai/leio-tool-todo'
import * as ToolSubagent from '@leio-ai/leio-tool-subagent'
import * as ToolWeb from '@leio-ai/leio-tool-web'
import VmWorkflowEngine from '@leio-ai/leio-workflow-worker-thread'
import * as ToolRalph from '@leio-ai/leio-tool-ralph'
import * as ToolWorkflow from '@leio-ai/leio-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@leio-ai/leio-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  },
  {
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@leio-ai/leio-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@leio-ai/leio-tool-pwsh',
    dir: 'tool-pwsh',
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@leio-ai/leio-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `DSH_*` environment comes from `@leio-ai/leio-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@leio-ai/leio-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see .agents/notes/implemented/feature/2026-07-08-self-referential-cordis-toolset.md). The toolset injects `ctx.dynamicCordisRunner` from `@leio-ai/leio-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or DSH restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@leio-ai/leio-tool-bash-persistent',
  ...
  {
    pkg: '@leio-ai/leio-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@leio-ai/leio-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. `read_image` is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@leio-ai/leio-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@leio-ai/leio-tool-terminal',
    dir: 'tool-terminal',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@leio-ai/leio-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@leio-ai/leio-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@leio-ai/leio-tool-session-query',
  ...
  {
    pkg: '@leio-ai/leio-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@leio-ai/leio-tool-subagent-control',
  ...
  {
    pkg: '@leio-ai/leio-tool-subagent-report',
  ...
  {
    pkg: '@leio-ai/leio-tool-workflow',
    dir: 'tool-workflow',
