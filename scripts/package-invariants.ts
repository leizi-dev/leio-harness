...
function checkManifest(
  ...
  if (owner.packageName === '@leio-ai/leio-invariants') return
  if (manifest.peerDependencies?.['@leio-ai/leio-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@leio-ai/leio-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@leio-ai/leio-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@leio-ai/leio-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@leio-ai/leio-invariants'
