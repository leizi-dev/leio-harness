...
- id: sdk-jsonrpc-server
  name: '@leio-ai/leio-sdk-jsonrpc-server'
- id: agent-core
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@leio-ai/leio-code-runtime-worker-thread'
- id: subagents
  name: '@leio-ai/leio-subagent'
- id: subagent-spawn-in-process
  name: '@leio-ai/leio-subagent-spawn-in-process'
  config:
    providerName: spawn
- id: subagent-tool
  ...
  config:
    provider: spawn
- id: workflow-engine
  name: '@leio-ai/leio-workflow-worker-thread'
  config:
    provider: spawn
- id: workflow-tool
  name: '@leio-ai/leio-tool-workflow'
- id: cordis-host-runner
  name: '@leio-ai/leio-cordis-host-runner'
- id: cordis-tool
  name: '@leio-ai/leio-tool-cordis'
"""
