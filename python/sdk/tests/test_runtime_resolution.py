...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@leio-ai/leio-agent-spine-demo" in config
    assert "@leio-ai/leio-session-persistence-jsonl" in config
    assert "@leio-ai/leio-session-checkpoint-policy" in config
