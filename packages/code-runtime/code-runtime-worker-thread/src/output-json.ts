/** JSON string-prefix accounting for the outer-output ledger. @module @leio-ai/leio-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@leio-ai/leio-code-runtime'
