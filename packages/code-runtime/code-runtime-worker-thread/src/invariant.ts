/**
 * Package-owned invariant companion for `@leio-ai/leio-code-runtime-worker-thread`.
 * @module @leio-ai/leio-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-code-runtime-worker-thread'
