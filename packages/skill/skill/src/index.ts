 ...
 * Concrete
 * providers such as `@leio-ai/leio-skill-filesystem` decide where skills come
 ...
 *
 * @module @leio-ai/leio-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { assertNever } from '@leio-ai/leio-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@leio-ai/leio-scope'
import type { ScopeKey, ScopeLayer } from '@leio-ai/leio-scope'
