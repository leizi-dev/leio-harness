/**
 * Package-owned invariant companion for `@leio-ai/leio-typert-generator`.
 * @module @leio-ai/leio-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-typert-generator'
