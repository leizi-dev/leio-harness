/**
 * Package-owned invariant companion for `@leio-ai/leio-typert-registry`.
 * @module @leio-ai/leio-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-typert-registry'
