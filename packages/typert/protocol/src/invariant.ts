/**
 * Package-owned invariant companion for `@leio-ai/leio-typert-protocol`.
 * @module @leio-ai/leio-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-typert-protocol'
