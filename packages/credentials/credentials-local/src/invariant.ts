/**
 * Package-owned invariant companion for `@leio-ai/leio-credentials-local`.
 * @module @leio-ai/leio-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-credentials-local'
