/**
 * Package-owned invariant companion for `@leio-ai/leio-storage-domain`: every
 ...
 * @module @leio-ai/leio-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-storage-domain'
