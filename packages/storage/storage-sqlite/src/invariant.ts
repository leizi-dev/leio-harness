/**
 * Package-owned invariant companion for `@leio-ai/leio-storage-sqlite`.
 * @module @leio-ai/leio-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-storage-sqlite'
