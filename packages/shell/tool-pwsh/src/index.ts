 ...
 * `@leio-ai/leio-pwsh-local`) backs `ctx.shell`; the tool contract is
 ...
 * exit-status parse from `@leio-ai/leio-shell`.
 *
 * @module @leio-ai/leio-tool-pwsh
 */

import { isAbsolute, resolve as resolvePath } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool, TOOL_ABORTED } from '@leio-ai/leio-tools'
import type { GenericCallView, TerminalCallView, ToolExecution, ToolResult, ToolResultView } from '@leio-ai/leio-tools'
import { HarnessError } from '@leio-ai/leio-llm'
import type { Agent } from '@leio-ai/leio-agent'
import type {} from '@leio-ai/leio-system-prompt'
import type {} from '@leio-ai/leio-jobs'
import type {} from '@leio-ai/leio-shell-env'
import type {} from '@leio-ai/leio-user-approval'
import type { SandboxExecutionPolicy, SandboxMode } from '@leio-ai/leio-sandbox'
import { ESCALATION_TARGETS, approveEscalation, validateEscalationArgs } from '@leio-ai/leio-sandbox'
import type { SandboxPolicyService } from '@leio-ai/leio-sandbox-policy'
import type { ShellRunResult } from '@leio-ai/leio-shell'
import { parseExitStatus } from '@leio-ai/leio-shell'
import { processOutcome } from './background.ts'
import { renderPwshProcessRead, renderPwshResult } from './render.ts'
import type { RenderablePwshResult } from './render.ts'

declare module '@leio-ai/leio-jobs' {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: PwshToolArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) {
          throw new Error('background jobs unavailable: load @leio-ai/leio-jobs and @leio-ai/leio-tool-jobs')
        }
