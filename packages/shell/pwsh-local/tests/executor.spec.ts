/**
 * Real-process tests for `@leio-ai/leio-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@leio-ai/leio-pwsh-local'
import LocalSubprocessRuntime from '@leio-ai/leio-subprocess-local'
import SubprocessRuntime from '@leio-ai/leio-subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@leio-ai/leio-subprocess'
import { MAX_TIMER_DELAY_MS } from '@leio-ai/leio-timeout'
import type { ShellProcess } from '@leio-ai/leio-shell'
