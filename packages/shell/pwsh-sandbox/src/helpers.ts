 ...
 * mirror of `@leio-ai/leio-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @leio-ai/leio-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@leio-ai/leio-shell'
import type { RunnerFailureRule } from '@leio-ai/leio-sandbox'
