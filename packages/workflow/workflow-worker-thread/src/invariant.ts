/**
 * Package-owned invariant companion for `@leio-ai/leio-workflow-worker-thread`.
 * @module @leio-ai/leio-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-workflow-worker-thread'
