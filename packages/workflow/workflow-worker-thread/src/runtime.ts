 ...
 * @module @leio-ai/leio-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@leio-ai/leio-llm'
import { SessionId } from '@leio-ai/leio-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@leio-ai/leio-tools'
import type { ObjectJsonSchema } from '@leio-ai/leio-tools'
import { isFatalWorkflowError, WorkflowError } from '@leio-ai/leio-workflow'
import type {
