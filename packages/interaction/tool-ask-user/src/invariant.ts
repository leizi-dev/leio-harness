/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-ask-user`.
 * @module @leio-ai/leio-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-ask-user'
