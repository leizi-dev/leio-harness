...
import type { Session, SessionEvent } from '@leio-ai/leio-session'
import type { SandboxMode } from '@leio-ai/leio-sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@leio-ai/leio-sandbox-policy'
...
import type {} from '@leio-ai/leio-shell'
import type { ApprovalPolicy } from '@leio-ai/leio-user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@leio-ai/leio-user-approval'
import { installSettingsSection, settingsNamespace } from '@leio-ai/leio-settings'
...
declare module '@leio-ai/leio-session/types' {
