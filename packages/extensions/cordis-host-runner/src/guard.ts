 ...
 * @module @leio-ai/leio-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@leio-ai/leio-scope'
import { assertSupportedJsonSchema, defineTool } from '@leio-ai/leio-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@leio-ai/leio-cordis-client-runner`, whose CTX_VERBS names this one its
