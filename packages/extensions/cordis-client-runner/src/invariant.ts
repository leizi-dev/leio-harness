/**
 * Package-owned invariant companion for `@leio-ai/leio-cordis-client-runner`.
 * @module @leio-ai/leio-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-cordis-client-runner'
