/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-cordis`.
 * @module @leio-ai/leio-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-cordis'
