/**
 * Package-owned invariant companion for `@leio-ai/leio-client-test-runtime`.
 * @module @leio-ai/leio-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-test-runtime'
