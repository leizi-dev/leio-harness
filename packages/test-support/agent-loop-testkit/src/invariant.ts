/**
 * Package-owned invariant companion for `@leio-ai/leio-agent-loop-testkit`.
 * @module @leio-ai/leio-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-agent-loop-testkit'
