/**
 * Package-owned invariant companion for `@leio-ai/leio-llm-mock-server`.
 * @module @leio-ai/leio-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-llm-mock-server'
