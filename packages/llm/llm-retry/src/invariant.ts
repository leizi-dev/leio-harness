/** Package-owned durable retry-event invariants. @module @leio-ai/leio-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@leio-ai/leio-session'
import type { LlmFailure } from '@leio-ai/leio-llm'
...
const PACKAGE_NAME = '@leio-ai/leio-llm-retry'
