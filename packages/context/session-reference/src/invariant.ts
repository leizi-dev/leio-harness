/**
 * Package-owned invariant companion for `@leio-ai/leio-session-reference`.
 * @module @leio-ai/leio-session-reference/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-reference'
