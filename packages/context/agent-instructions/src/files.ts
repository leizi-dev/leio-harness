 ...
 *
 * @module @leio-ai/leio-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@leio-ai/leio-fs'
import { assertNever } from '@leio-ai/leio-llm'
import { dshHomeDisplay } from '@leio-ai/leio-home-paths'
