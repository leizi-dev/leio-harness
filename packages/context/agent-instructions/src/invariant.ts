/**
 * Package-owned invariant companion for `@leio-ai/leio-agent-instructions`.
 * @module @leio-ai/leio-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-agent-instructions'
