...
import LlmRuntime, { createUserMessage, CallId, type Message, type StreamChunk } from '@leio-ai/leio-llm'
import SessionStore, { Session, SessionId, SESSION_FORMAT_VERSION, type SessionEvent, type UserMessage } from '@leio-ai/leio-session'
import AgentRegistry, { agentEvents, Inbox, type Agent } from '@leio-ai/leio-agent'
import AgentLoop from '@leio-ai/leio-agent-loop'
import { FileSystem, FsTargetKey, FsVersion } from '@leio-ai/leio-fs'
import type {
  FsDirEntry,
  FsEditOutcome,
  FsEditRequest,
...
import type {
  ToolExecution,
  ToolExecutionToken,
} from '@leio-ai/leio-tools'
import * as ToolFs from '@leio-ai/leio-tool-fs'
import {
  discoverBaselineInstructionFiles,
  loadBaselineInstructions,
  renderWorkspaceContext,
} from '@leio-ai/leio-agent-instructions'
import {
...
describe('workspace context instruction discovery', () => {
  ...
  it('labels the default DSH home as ~/.dsh when HOME points at the configured default', async () => {
    ...
    try {
      ...
      const isolated = await import('@leio-ai/leio-agent-instructions')
