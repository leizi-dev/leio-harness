/**
 * Package-owned invariant companion for `@leio-ai/leio-repeat-tool-reminder`.
 * @module @leio-ai/leio-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-repeat-tool-reminder'
