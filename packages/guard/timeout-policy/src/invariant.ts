/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-call-timeout-policy`.
 * @module @leio-ai/leio-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-call-timeout-policy'
