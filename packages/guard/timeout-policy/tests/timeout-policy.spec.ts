/**
 * Unit + real-load-path coverage for @leio-ai/leio-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@leio-ai/leio-llm'
import SystemPrompt from '@leio-ai/leio-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@leio-ai/leio-tools'
import * as timeoutPolicy from '@leio-ai/leio-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@leio-ai/leio-tool-call-timeout-policy'
