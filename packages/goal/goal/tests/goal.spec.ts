...
import { createUserMessage, HarnessError } from '@leio-ai/leio-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@leio-ai/leio-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@leio-ai/leio-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@leio-ai/leio-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@leio-ai/leio-session').SessionEvent[]): StubAgent {
