 ...
 * @module @leio-ai/leio-tool-goal
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { GoalId } from '@leio-ai/leio-goal'
import type { GoalRef, GoalView } from '@leio-ai/leio-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@leio-ai/leio-llm'
import { defineTool } from '@leio-ai/leio-tools'
import type { GenericCallView } from '@leio-ai/leio-tools'
