...
import * as GoalSessionInvariant from '@leio-ai/leio-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@leio-ai/leio-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@leio-ai/leio-invariants'
import SessionStore, { SessionId, type Session } from '@leio-ai/leio-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@leio-ai/leio-goal-round-driver',
    }))
  })
