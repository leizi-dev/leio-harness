/** Package-owned goal-round prompt invariants. @module @leio-ai/leio-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@deepseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@leio-ai/leio-goal'
import type { InvariantFailure, InvariantInstaller } from '@leio-ai/leio-invariants'
import type { Session, SessionEvent } from '@leio-ai/leio-session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@leio-ai/leio-goal-round-driver'
