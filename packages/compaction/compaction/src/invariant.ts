/** Package-owned compaction log-stream invariants. @module @leio-ai/leio-compaction/invariant */

import type { Context } from '@deepseek-ai/cordis'
import { isReplacementSurfaceEvent } from '@leio-ai/leio-session'
...
const PACKAGE_NAME = '@leio-ai/leio-compaction'
