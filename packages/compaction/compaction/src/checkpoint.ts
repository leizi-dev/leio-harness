 ...
 *
 * The seam itself lives in `@leio-ai/leio-compaction`, which re-exports these
 ...
 *
 * @module @leio-ai/leio-compaction/checkpoint
 */

import type { MessageSource } from '@leio-ai/leio-llm/message'
