/**
 * Package-owned invariant companion for `@leio-ai/leio-command-compact`.
 * @module @leio-ai/leio-command-compact/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-command-compact'
