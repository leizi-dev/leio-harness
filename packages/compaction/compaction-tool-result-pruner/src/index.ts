 ...
 *
 * @module @leio-ai/leio-compaction-tool-result-pruner
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { freezeMessage } from '@leio-ai/leio-llm'
import type { ContentBlock } from '@leio-ai/leio-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@leio-ai/leio-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@leio-ai/leio-compaction'
