/**
 * Package-owned invariant companion for `@leio-ai/leio-compaction-tool-result-pruner`.
 * @module @leio-ai/leio-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-compaction-tool-result-pruner'
