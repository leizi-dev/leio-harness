 ...
 *
 * @module @leio-ai/leio-compaction-basic
 */

import { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { CompactionEngine, ManualCompactionError } from '@leio-ai/leio-compaction'
import type { CompactionResult, CompactionTrigger } from '@leio-ai/leio-compaction'
import type { TokenMeter } from '@leio-ai/leio-token-meter'
import type { Session } from '@leio-ai/leio-session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@leio-ai/leio-llm'
import type { LlmCallConfig } from '@leio-ai/leio-llm'
import type { Agent, PreStepDecision } from '@leio-ai/leio-agent'
import type { CommandId } from '@leio-ai/leio-commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from '@leio-ai/leio-compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
