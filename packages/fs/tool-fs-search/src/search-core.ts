 ...
 *
 * @module @leio-ai/leio-tool-fs-search/search-core
 */

import { isAbsolute, relative, sep } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { HarnessError } from '@leio-ai/leio-llm'
import { ItemRetainer, TextRetainer } from '@leio-ai/leio-output-retention'
import type { RetainedItems } from '@leio-ai/leio-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@leio-ai/leio-subprocess'
 ...
 * `@leio-ai/leio-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@leio-ai/leio-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@leio-ai/leio-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@leio-ai/leio-tool-fs-search/presentation} `grepSearchMeta`)
