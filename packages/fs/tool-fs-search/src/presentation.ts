 ...
 * model-facing render consumes ({@link module:@leio-ai/leio-tool-fs-search/search-core}
 ...
 *
 * @module @leio-ai/leio-tool-fs-search/presentation
 */
 ...
 * ({@link module:@leio-ai/leio-tool-fs-search/grep} `formatGrepMatches`), so
