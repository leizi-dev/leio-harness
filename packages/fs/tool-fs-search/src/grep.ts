 ...
 *
 * @module @leio-ai/leio-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@leio-ai/leio-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@leio-ai/leio-tools'
import type { RetainedItems } from '@leio-ai/leio-output-retention'
import type { SpillRef } from '@leio-ai/leio-spill'
