/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-fs-search`.
 * @module @leio-ai/leio-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-fs-search'
