 ...
 * @module @leio-ai/leio-tool-fs/src/write
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@leio-ai/leio-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@leio-ai/leio-tools'
import type { FsWriteOutcome } from '@leio-ai/leio-fs'
