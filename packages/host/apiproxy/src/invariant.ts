/**
 * Package-owned invariant companion for `@leio-ai/leio-host-apiproxy`.
 * @module @leio-ai/leio-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-host-apiproxy'
