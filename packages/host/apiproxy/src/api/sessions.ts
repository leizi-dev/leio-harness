...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@leio-ai/leio-attachment'
import type { ContentBlock } from '@leio-ai/leio-llm/types'
import type { SessionEvent, SessionId } from '@leio-ai/leio-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@leio-ai/leio-session-projection/types'
...
declare module '@leio-ai/leio-llm' {
