...
import { TypertLookupFailure } from '@leio-ai/leio-typert-protocol'
import TypertRegistry from '@leio-ai/leio-typert-registry'
import { createUserMessage, MessageId } from '@leio-ai/leio-llm'
import type { Agent } from '@leio-ai/leio-agent'
import UserQuestionService from '@leio-ai/leio-user-questions'
import type { SessionEvent, SessionHeader, SessionId } from '@leio-ai/leio-session'
import {
  PersistenceCoordinator,
  SessionPersistenceRevision,
  type PersistenceBackend,
  type StoredPrefix,
} from '@leio-ai/leio-session-persistence'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@leio-ai/leio-session').Session
