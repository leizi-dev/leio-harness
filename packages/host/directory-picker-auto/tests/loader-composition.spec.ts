...
import HttpServer from '@leio-ai/leio-host-webserver'
import type { DirectoryPicker } from '@leio-ai/leio-host-directory-picker'
import BrowseDirectoryPicker from '@leio-ai/leio-host-directory-picker-browse'
import NativeDirectoryPicker from '@leio-ai/leio-host-directory-picker-native'
...
const AUTO = '@leio-ai/leio-host-directory-picker-auto'
const NATIVE = '@leio-ai/leio-host-directory-picker-native'
const BROWSE = '@leio-ai/leio-host-directory-picker-browse'
const NATIVE_SURFACE = '@leio-ai/leio-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@leio-ai/leio-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@leio-ai/leio-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@leio-ai/leio-host-webserver', HttpServer],
