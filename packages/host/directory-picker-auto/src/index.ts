 ...
 * @module @leio-ai/leio-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@leio-ai/leio-host-directory-picker-native',
  browse: '@leio-ai/leio-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@leio-ai/leio-client-ui-directory-picker-native',
  browse: '@leio-ai/leio-client-ui-directory-picker-browse',
}
