/** Package-owned invariant companion for the directory-picker seam. @module @leio-ai/leio-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@leio-ai/leio-invariants'

const PACKAGE_NAME = '@leio-ai/leio-host-directory-picker'
