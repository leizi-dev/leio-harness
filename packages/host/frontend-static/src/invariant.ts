/**
 * Package-owned invariant companion for `@leio-ai/leio-host-frontend-static`.
 * @module @leio-ai/leio-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@leio-ai/leio-invariants'

const PACKAGE_NAME = '@leio-ai/leio-host-frontend-static'
