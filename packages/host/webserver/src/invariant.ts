/**
 * Package-owned invariant companion for `@leio-ai/leio-host-webserver`.
 * @module @leio-ai/leio-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-host-webserver'
