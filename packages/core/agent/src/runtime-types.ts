 ...
 * turn/step boundaries remain `@leio-ai/leio-session` events.
 *
 * @module @leio-ai/leio-agent
 */

import type { Context } from '@deepseek-ai/cordis'
import type { Scoped } from '@leio-ai/leio-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@leio-ai/leio-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@leio-ai/leio-session'
export type { AgentCancelCause } from '@leio-ai/leio-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@leio-ai/leio-system-prompt'
declare module '@leio-ai/leio-system-prompt' {
...
declare module '@deepseek-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@leio-ai/leio-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
