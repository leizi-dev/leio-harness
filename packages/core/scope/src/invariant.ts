/** Package-owned scoped-dispatch invariants. @module @leio-ai/leio-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@leio-ai/leio-invariants'
import { carrierKeyOf, isScopeCarrier } from '@leio-ai/leio-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@leio-ai/leio-scope'
