/**
 * Package-owned invariant companion for `@leio-ai/leio-agent-tool-presentation`.
 * @module @leio-ai/leio-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-agent-tool-presentation'
