 ...
 *
 * @module @leio-ai/leio-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@leio-ai/leio-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@leio-ai/leio-scope'
import type { ContextSnapshotSection, ToolSchema } from '@leio-ai/leio-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@leio-ai/leio-scope`): scoped listeners
  ...
  constructor(ctx: Context, config: Config) {
    ...
    if (config.includeHarnessIdentity ?? true) {
      this.section({
        ...
        order: -100,
        text: 'You are an AI agent powered by Leio Harness.',
      })
    }
    this.section({
