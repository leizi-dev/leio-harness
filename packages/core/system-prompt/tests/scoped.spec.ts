...
import { createScope, scopeOf } from '@leio-ai/leio-scope'
import type { Scope, ScopeKey } from '@leio-ai/leio-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@leio-ai/leio-system-prompt'
import type { Config, PromptAssembly } from '@leio-ai/leio-system-prompt'
