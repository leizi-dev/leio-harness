 ...
 * @module @leio-ai/leio-tool-terminal
 */
...
import { TerminalSessionId } from '@leio-ai/leio-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@leio-ai/leio-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @leio-ai/leio-jobs and @leio-ai/leio-tool-jobs')
