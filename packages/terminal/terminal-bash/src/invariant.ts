/**
 * Package-owned invariant companion for `@leio-ai/leio-terminal-bash`.
 * @module @leio-ai/leio-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-terminal-bash'
