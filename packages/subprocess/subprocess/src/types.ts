...
/** Namespace prefix reserved for Leio Harness-managed child environment facts. */
export const DSH_ENV_PREFIX = 'DSH_' as const

/** One environment key inside the managed {@link DSH_ENV_PREFIX} namespace. */
export type DshEnvironmentKey = `${typeof DSH_ENV_PREFIX}${string}`

/** Trusted Leio Harness variables for one child-process execution. */
 ...
 * to `TerminalSignal` in `@leio-ai/leio-terminal` without a cross-seam dependency;
