/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-commands`.
 * @module @leio-ai/leio-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-commands'
