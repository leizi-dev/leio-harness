...
import * as UiSlots from '@leio-ai/leio-client-ui-slots'
import * as WebReact from '@leio-ai/leio-client-web-react'
import * as UiPrimitives from '@leio-ai/leio-client-ui-primitives'
import * as UiAttachment from '@leio-ai/leio-client-ui-attachment'
import * as SchemaForm from '@leio-ai/leio-client-schema-form'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@leio-ai/leio-client-ui-slots': UiSlots,
    '@leio-ai/leio-client-web-react': WebReact,
    '@leio-ai/leio-client-ui-primitives': UiPrimitives,
    '@leio-ai/leio-client-ui-attachment': UiAttachment,
    '@leio-ai/leio-client-schema-form': SchemaForm,
