/**
 * Package-owned invariant companion for `@leio-ai/leio-client-connection`.
 * @module @leio-ai/leio-client-connection/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-connection'
