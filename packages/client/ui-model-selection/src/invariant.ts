/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-model-selection`.
 * @module @leio-ai/leio-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-model-selection'
