/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-goal`.
 * @module @leio-ai/leio-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-goal'
