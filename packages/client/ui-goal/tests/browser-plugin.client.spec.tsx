...
import { SlotRegistry, type SessionId } from '@leio-ai/leio-client-runtime/client'
import { ConversationEventRegistry } from '@leio-ai/leio-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@leio-ai/leio-goal/client'
