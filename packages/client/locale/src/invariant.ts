/**
 * Package-owned invariant companion for `@leio-ai/leio-client-locale`.
 * @module @leio-ai/leio-client-locale/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-locale'
