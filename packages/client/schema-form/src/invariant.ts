/**
 * Package-owned invariant companion for `@leio-ai/leio-client-schema-form`.
 * @module @leio-ai/leio-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-schema-form'
