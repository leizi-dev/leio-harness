/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-skill`.
 * @module @leio-ai/leio-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-skill'
