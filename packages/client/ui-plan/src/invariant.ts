/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-plan`.
 * @module @leio-ai/leio-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-plan'
