/**
 * Package-owned invariant companion for `@leio-ai/leio-client-modules`.
 * @module @leio-ai/leio-client-modules/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-modules'
