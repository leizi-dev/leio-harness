/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-slots`.
 * @module @leio-ai/leio-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-slots'
