/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-settings-general`.
 * @module @leio-ai/leio-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-settings-general'
