/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-theme`.
 * @module @leio-ai/leio-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-theme'
