/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-settings-plugins`.
 * @module @leio-ai/leio-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-settings-plugins'
