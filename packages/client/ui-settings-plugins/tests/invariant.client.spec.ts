...
import * as PluginConfigInvariant from '@leio-ai/leio-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@leio-ai/leio-client-ui-settings-plugins')
