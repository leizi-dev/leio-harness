/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-subagent`.
 * @module @leio-ai/leio-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-subagent'
