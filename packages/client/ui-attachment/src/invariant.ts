/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-attachment`.
 * @module @leio-ai/leio-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-attachment'
