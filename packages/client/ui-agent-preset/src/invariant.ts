/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-agent-preset`.
 * @module @leio-ai/leio-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-agent-preset'
