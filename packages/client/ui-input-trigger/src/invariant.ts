/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-input-trigger`.
 * @module @leio-ai/leio-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-input-trigger'
