...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@leio-ai/leio-client-ui-theme/client'
import { apply, inject, LayoutController } from '@leio-ai/leio-client-ui-layout/client'
import { apply as nodeApply } from '@leio-ai/leio-client-ui-layout'
import * as invariant from '@leio-ai/leio-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@leio-ai/leio-client-ui-layout', expect.any(Function))
