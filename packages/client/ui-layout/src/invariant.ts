/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-layout`.
 * @module @leio-ai/leio-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-layout'
