/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-directory-picker-native`.
 * @module @leio-ai/leio-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-directory-picker-native'
