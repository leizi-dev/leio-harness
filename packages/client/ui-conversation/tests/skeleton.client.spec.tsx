...
import { en as commonEn } from '@leio-ai/leio-client-locale/src/locales/en.ts'
...
describe('ConversationRoot resident composer', () => {
  ...
  it('hero phase: same textarea, hero chrome, no header, picker switches the workspace', () => {
    ...
    expect(b.view.getByText('如入无人之境')).toBeTruthy()
    expect(b.view.getByText('预览版')).toBeTruthy()
    expect(b.view.container.querySelector('img[src="/leio-icon.png"]')).toBeTruthy()
  ...
  it('settling phase: a summary that does not prove the session blank hides the composer while it opens', () => {
    ...
    expect(b.view.queryByText('如入无人之境')).toBeNull()
  })
