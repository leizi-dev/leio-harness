...
import { AttachmentRail, DropOverlay, ImageLightbox } from '@leio-ai/leio-client-ui-attachment'
import type { AttachmentRailItem } from '@leio-ai/leio-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@leio-ai/leio-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@leio-ai/leio-goal/client'
...
import type { Translate } from '@leio-ai/leio-client-ui-slots'
