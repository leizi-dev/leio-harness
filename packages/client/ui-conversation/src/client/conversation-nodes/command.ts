...
import { isReplacementSurfaceEvent } from '@leio-ai/leio-client-runtime/client'
import type { CompactionCheckpointSource } from '@leio-ai/leio-compaction/checkpoint'
import type {} from '@leio-ai/leio-compaction/types'
import type {} from '@leio-ai/leio-commands/types'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@leio-ai/leio-client-ui-conversation/client' {
