/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-permission-presets`.
 * @module @leio-ai/leio-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-permission-presets'
