/**
 * Package-owned invariant companion for `@leio-ai/leio-client-web-react`.
 * @module @leio-ai/leio-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-web-react'
