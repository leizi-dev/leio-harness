/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-settings-models`.
 * @module @leio-ai/leio-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-settings-models'
