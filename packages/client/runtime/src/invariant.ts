/**
 * Package-owned invariant companion for `@leio-ai/leio-client-runtime`.
 * @module @leio-ai/leio-client-runtime/invariant
 */
...
import type { SlotMap } from '@leio-ai/leio-client-ui-slots'
import type { InvariantInstaller } from '@leio-ai/leio-invariants'

const PACKAGE_NAME = '@leio-ai/leio-client-runtime'
