/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-message-feedback`.
 * @module @leio-ai/leio-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-message-feedback'
