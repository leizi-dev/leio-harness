/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-jobs`.
 * @module @leio-ai/leio-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-jobs'
