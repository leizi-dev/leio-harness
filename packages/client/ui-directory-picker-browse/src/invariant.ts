/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-directory-picker-browse`.
 * @module @leio-ai/leio-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-directory-picker-browse'
