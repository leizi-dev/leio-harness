...
import type { SessionProviderComponent, TranslateNS } from '@leio-ai/leio-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@leio-ai/leio-client-ui-conversation/src/client/contract/slots.ts'
