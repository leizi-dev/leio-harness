/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-tool`.
 * @module @leio-ai/leio-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-tool'
