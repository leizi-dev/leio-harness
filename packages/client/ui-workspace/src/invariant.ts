/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-workspace`.
 * @module @leio-ai/leio-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-workspace'
