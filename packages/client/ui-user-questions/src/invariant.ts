/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-user-questions`.
 * @module @leio-ai/leio-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-user-questions'
