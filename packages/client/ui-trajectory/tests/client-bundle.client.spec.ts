 ...
 * not built (`pnpm --filter @leio-ai/leio-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@leio-ai/leio-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@leio-ai/leio-client-runtime/client', await import('@leio-ai/leio-client-runtime/client')],
      ['@leio-ai/leio-client-ui-primitives', await import('@leio-ai/leio-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@leio-ai/leio-client-locale/client')
