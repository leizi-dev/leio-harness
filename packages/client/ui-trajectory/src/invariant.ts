/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-trajectory`.
 * @module @leio-ai/leio-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-trajectory'
