 ...
 */
export const INLINE_SAFE = /^@leio-ai\/leio-(host-apiproxy|session|llm|tools|brand)(\/|$)/
...
const GENERATED_REMOTE = /^@leio-ai\/leio-[a-z0-9]+(?:-[a-z0-9]+)*\/remote$/
 ...
 */
const RUNTIME_STORE_EXEMPTION = '@leio-ai/leio-client-runtime/client'
  ...
  return {
    ...
    plugins: [{
      ...
      resolveId(source: string) {
        if (!source.startsWith('@leio-ai/') && !source.startsWith('@deepseek-ai/')) return null
