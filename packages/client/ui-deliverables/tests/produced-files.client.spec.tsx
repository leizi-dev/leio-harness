...
import type { ChatFileMentions, TurnTailOwnerProps } from '@leio-ai/leio-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@leio-ai/leio-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@leio-ai/leio-client-ui-deliverables'])
