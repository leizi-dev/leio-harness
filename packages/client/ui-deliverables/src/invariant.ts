/**
 * Package-owned invariant companion for `@leio-ai/leio-client-ui-deliverables`.
 * @module @leio-ai/leio-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-client-ui-deliverables'
