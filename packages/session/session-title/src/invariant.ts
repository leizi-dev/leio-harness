/**
 * Package-owned invariant companion for `@leio-ai/leio-session-title`.
 * @module @leio-ai/leio-session-title/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-title'
