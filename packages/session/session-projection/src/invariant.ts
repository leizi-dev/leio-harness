/**
 * Package-owned invariant companion for `@leio-ai/leio-session-projection`.
 * @module @leio-ai/leio-session-projection/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-projection'
