/**
 * Package-owned invariant companion for `@leio-ai/leio-session-title-llm`.
 * @module @leio-ai/leio-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-title-llm'
