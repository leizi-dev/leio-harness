/**
 * Package-owned invariant companion for `@leio-ai/leio-session-telemetry`.
 * @module @leio-ai/leio-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-telemetry'
