/**
 * Package-owned invariant companion for `@leio-ai/leio-session-persistence-jsonl`.
 * @module @leio-ai/leio-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-persistence-jsonl'
