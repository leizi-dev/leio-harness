/**
 * Package-owned invariant companion for `@leio-ai/leio-session-title-first-prompt-llm`.
 * @module @leio-ai/leio-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-title-first-prompt-llm'
