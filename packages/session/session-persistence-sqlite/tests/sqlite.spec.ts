...
import type { Session, SessionEvent, SurfaceEvent, SurfaceEventType } from '@leio-ai/leio-session'
import SqliteSessionPersistence, { SCHEMA_VERSION } from '@leio-ai/leio-session-persistence-sqlite'
import {
  openDatabase,
  rowToEvent,
  rowToMeta,
