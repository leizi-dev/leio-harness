/**
 * Package-owned invariant companion for `@leio-ai/leio-session-persistence-sqlite`.
 * @module @leio-ai/leio-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-persistence-sqlite'
