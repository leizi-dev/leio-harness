/**
 * Package-owned invariant companion for `@leio-ai/leio-session-projection-cache`.
 * @module @leio-ai/leio-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-projection-cache'
