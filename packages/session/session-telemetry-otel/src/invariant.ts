/**
 * Package-owned invariant companion for `@leio-ai/leio-session-telemetry-otel`.
 * @module @leio-ai/leio-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-telemetry-otel'
