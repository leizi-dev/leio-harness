/**
 * OpenTelemetry Service Provider for the Leio Harness telemetry capability.
 *
 ...
 *
 * @module @leio-ai/leio-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@leio-ai/leio-command-feedback'
import {
...
} from '@leio-ai/leio-session-telemetry'
import { APP_IDENTITY } from '@leio-ai/leio-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@leio-ai/leio-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@leio-ai/leio-session-telemetry-otel/ops', version)
