 ...
 * @module @leio-ai/leio-session-persistence
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { SessionPreparation } from '@leio-ai/leio-session'
import type { SessionEvent, SessionId, SessionHeader } from '@leio-ai/leio-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@leio-ai/leio-session'
