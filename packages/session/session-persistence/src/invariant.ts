/**
 * Package-owned invariant companion for `@leio-ai/leio-session-persistence`.
 * @module @leio-ai/leio-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-persistence'
