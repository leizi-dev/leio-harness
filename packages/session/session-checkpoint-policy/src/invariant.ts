/**
 * Package-owned invariant companion for `@leio-ai/leio-session-checkpoint-policy`.
 * @module @leio-ai/leio-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-checkpoint-policy'
