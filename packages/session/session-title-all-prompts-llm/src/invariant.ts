/**
 * Package-owned invariant companion for `@leio-ai/leio-session-title-all-prompts-llm`.
 * @module @leio-ai/leio-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-title-all-prompts-llm'
