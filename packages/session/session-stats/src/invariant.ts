/**
 * Package-owned invariant companion for `@leio-ai/leio-session-stats`.
 * @module @leio-ai/leio-session-stats/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-stats'
