...
import SessionStore, { foldSurface, Session, SessionId } from '@leio-ai/leio-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@leio-ai/leio-session-telemetry'
...
vi.mock('@leio-ai/leio-anonymous-user-id', () => ({
...
describe('@leio-ai/leio-command-feedback registration', () => {
