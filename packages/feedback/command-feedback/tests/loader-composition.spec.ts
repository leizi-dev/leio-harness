...
import * as CommandFeedback from '@leio-ai/leio-command-feedback'
...
describe('/feedback real Loader composition through cordis.yml', () => {
  it('boots cordis.yml and records feedback without model-visible output', async () => {
    ...
    await writeFile(configPath, [
      ...
      "- name: '@leio-ai/leio-commands'",
      "- name: '@leio-ai/leio-command-feedback'",
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@leio-ai/leio-commands', CommandRuntime],
      ['@leio-ai/leio-command-feedback', CommandFeedback],
    ])
