/**
 * Package-owned invariant companion for `@leio-ai/leio-command-feedback`.
 * @module @leio-ai/leio-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-command-feedback'
