/**
 * @leio-ai/leio-web-app — the browser-surface bundle's runtime glue plugin
...
import { addHarnessSourceSection } from '@leio-ai/leio-app-boot'
import * as FrontendStatic from '@leio-ai/leio-host-frontend-static'
...
function webSurfacePrompt(webUrl: string): string {
  ...
  return `You are interacting with the user through the Leio Harness Web GUI at ${webUrl}. `
...
function resolveDistIndex(): string {
  ...
  try {
    return require.resolve('@leio-ai/leio-web-frontend/dist/index.html')
  } catch {
  ...
  if (config.surfaceContext) {
    ...
    ctx.inject(['shellEnv'], (runtimeCtx) => {
      runtimeCtx.shellEnv.register({
        name: 'web-runtime',
        variables: {
          [DSH_WEB_URL]: { description: 'Canonical local URL of the Leio Harness Web GUI serving this session.' },
        },
