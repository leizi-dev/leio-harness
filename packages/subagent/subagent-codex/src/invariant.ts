/**
 * Package-owned invariant companion for `@leio-ai/leio-subagent-codex`.
 * @module @leio-ai/leio-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-subagent-codex'
