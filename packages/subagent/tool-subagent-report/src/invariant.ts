/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-subagent-report`.
 * @module @leio-ai/leio-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-subagent-report'
