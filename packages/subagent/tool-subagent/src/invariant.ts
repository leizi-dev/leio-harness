/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-subagent`.
 * @module @leio-ai/leio-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-subagent'
