/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-subagent-control`.
 * @module @leio-ai/leio-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-subagent-control'
