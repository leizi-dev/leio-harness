/**
 * Fresh-process SDK subagent client. Drives one child Leio Harness
 * runtime over stdio JSON-RPC through `@leio-ai/leio-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@leio-ai/leio-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @leio-ai/leio-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@leio-ai/leio-sdk-client'
import type { ContentBlock } from '@leio-ai/leio-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@leio-ai/leio-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@leio-ai/leio-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@leio-ai/leio-subagent'
import { scrubbedParentEnv } from '@leio-ai/leio-subprocess'
