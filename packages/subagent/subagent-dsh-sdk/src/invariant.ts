/**
 * Package-owned invariant companion for `@leio-ai/leio-subagent-dsh-sdk`.
 * @module @leio-ai/leio-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-subagent-dsh-sdk'
