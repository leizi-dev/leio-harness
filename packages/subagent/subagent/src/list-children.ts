...
import type { SessionProjectionRegistry } from '@leio-ai/leio-session-projection'
import type { SessionProjectionCache } from '@leio-ai/leio-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @leio-ai/leio-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @leio-ai/leio-session)',
