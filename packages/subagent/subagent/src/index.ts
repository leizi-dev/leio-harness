 ...
 * (`@leio-ai/leio-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@leio-ai/leio-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@leio-ai/leio-tools'
import type { ContentBlock, MessageId } from '@leio-ai/leio-llm'
