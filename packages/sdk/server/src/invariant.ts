/**
 * Package-owned invariant companion for `@leio-ai/leio-sdk-jsonrpc-server`.
 * @module @leio-ai/leio-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-sdk-jsonrpc-server'
