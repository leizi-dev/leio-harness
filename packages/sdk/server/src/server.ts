 ...
 *
 * @module @leio-ai/leio-sdk-jsonrpc-server/server
 */

import type { Context } from '@deepseek-ai/cordis'
import { resolve } from 'node:path'
import type { Agent, AgentHandle } from '@leio-ai/leio-agent'
import { createUserMessage } from '@leio-ai/leio-llm'
import { carrierKeyOf, type Scoped } from '@leio-ai/leio-scope'
import { SessionId } from '@leio-ai/leio-session'
import type SubagentRuntime from '@leio-ai/leio-subagent'
import type { SubagentRunEndInfo } from '@leio-ai/leio-subagent'
...
export class HarnessSdkJsonRpcServer {
  ...
  async handleRequest(method: string, params: Record<string, unknown> | undefined): Promise<unknown> {
    switch (method) {
      ...
      default:
        throw new Error(`unknown Leio Harness SDK runtime method: ${method}`)
    }
  }
  ...
  private async createSession(sessionId: string): Promise<SessionRecord> {
    ...
    // (@leio-ai/leio-agent-presets README, "Composing a child agent").
