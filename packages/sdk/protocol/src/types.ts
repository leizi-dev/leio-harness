/**
 * Named wire types for the Leio Harness SDK runtime protocol: the three
 * request/result pairs and the four server-to-client notification payloads
 * exchanged over the newline-delimited JSON-RPC stdio transport. The server
 * plugin (`@leio-ai/leio-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @leio-ai/leio-sdk-protocol/types
 */

import type { ContentBlock } from '@leio-ai/leio-llm'
import type { SessionEvent } from '@leio-ai/leio-session'
import type { SubagentStopReason } from '@leio-ai/leio-subagent'
