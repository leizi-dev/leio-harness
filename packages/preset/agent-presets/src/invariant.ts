/**
 * Package-owned invariant companion for `@leio-ai/leio-agent-presets`.
 * @module @leio-ai/leio-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@leio-ai/leio-agent-presets'

const PACKAGE_NAME = '@leio-ai/leio-agent-presets'
