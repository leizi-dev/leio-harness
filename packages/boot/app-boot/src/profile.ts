 ...
 * @module @leio-ai/leio-app-boot/profile
 */
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@leio-ai/leio-base', '@leio-ai/leio-web-app'],
  headless: ['@leio-ai/leio-base', '@leio-ai/leio-headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@leio-ai/leio-base', '@leio-ai/leio-web-app', '@leio-ai/leio-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@leio-ai/leio-base']
 ...
 * `@leio-ai/leio-base` (and every other in-box bundle) always comes from
