 ...
 * `@leio-ai/leio-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @leio-ai/leio-web-fetch-http/provider
 */

import { WebError } from '@leio-ai/leio-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@leio-ai/leio-web'
