...
import type { WebSearchProvider, WebSearchResult } from '@leio-ai/leio-web'
...
} from '@leio-ai/leio-tool-web'
import type { ContentBlock } from '@leio-ai/leio-llm'
import type { ToolResult } from '@leio-ai/leio-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@leio-ai/leio-web').WebFetchProvider
