/**
 * `@leio-ai/leio-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@leio-ai/leio-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@leio-ai/leio-web`.
 *
 * @module @leio-ai/leio-web-search-exa
 */
