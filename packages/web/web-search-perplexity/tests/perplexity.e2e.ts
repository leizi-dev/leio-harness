...
import { PerplexitySearchProvider, PERPLEXITY_DEFAULT_BASE_URL, PERPLEXITY_DEFAULT_MAX_TOKENS, PERPLEXITY_DEFAULT_MODEL } from '@leio-ai/leio-web-search-perplexity'
...
maybe('PerplexitySearchProvider real API', () => {
  it('returns a generated answer and sources for a live query', async () => {
    ...
    const result = await provider.search({ query: 'What is Leio Harness?', maxResults: 5 })
