/**
 * Package-owned invariant companion for `@leio-ai/leio-web-search-deepseek`.
 * @module @leio-ai/leio-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-web-search-deepseek'
