/**
 * Package-owned invariant companion for `@leio-ai/leio-hooks-claude-code`.
 * @module @leio-ai/leio-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-hooks-claude-code'
