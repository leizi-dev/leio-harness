/**
 * Package-owned invariant companion for `@leio-ai/leio-anonymous-user-id`.
 * @module @leio-ai/leio-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-anonymous-user-id'
