/**
 * Package-owned invariant companion for `@leio-ai/leio-workspace`.
 * @module @leio-ai/leio-workspace/invariant
 */
...
import { WorkspaceId } from '@leio-ai/leio-workspace'

const PACKAGE_NAME = '@leio-ai/leio-workspace'
