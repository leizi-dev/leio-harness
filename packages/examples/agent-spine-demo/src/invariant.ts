/**
 * Package-owned invariant companion for `@leio-ai/leio-agent-spine-demo`.
 * @module @leio-ai/leio-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-agent-spine-demo'
