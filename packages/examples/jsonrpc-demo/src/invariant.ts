/**
 * Package-owned invariant companion for `@leio-ai/leio-sdk-jsonrpc-demo`.
 * @module @leio-ai/leio-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-sdk-jsonrpc-demo'
