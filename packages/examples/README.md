...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@leio-ai/leio-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@leio-ai/leio-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@leio-ai/leio-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
