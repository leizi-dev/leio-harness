 ...
 * ({@link @leio-ai/leio-agent-spine-demo}), JSONL session persistence, and
 * the {@link @leio-ai/leio-acp} bridge. The app owns those plugins through one
 ...
 * @module @leio-ai/leio-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@leio-ai/leio-acp'
import * as agentCore from '@leio-ai/leio-agent-spine-demo'
...
} from '@leio-ai/leio-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@leio-ai/leio-session-checkpoint-policy'
