/**
 * Package-owned invariant companion for `@leio-ai/leio-session-query-sqlite`.
 * @module @leio-ai/leio-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-session-query-sqlite'
