/**
 * Package-owned invariant companion for `@leio-ai/leio-tool-session-query`.
 * @module @leio-ai/leio-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-tool-session-query'
