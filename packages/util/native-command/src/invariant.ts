/**
 * Package-owned invariant companion for `@leio-ai/leio-native-command`.
 * @module @leio-ai/leio-native-command/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-native-command'
