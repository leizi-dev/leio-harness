/**
 * Package-owned invariant companion for `@leio-ai/leio-output-retention`.
 * @module @leio-ai/leio-output-retention/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-output-retention'
