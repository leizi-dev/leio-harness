/**
 * Shared filesystem path helpers for Leio Harness user data.
 *
 * @module @leio-ai/leio-home-paths
 */
...
/** Directory name for the default Leio Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default Leio Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default Leio Harness home. */
...
/**
 * Resolve the default Leio Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root Leio Harness home.
 *
...
/**
 * Join path segments onto the resolved Leio Harness home.
