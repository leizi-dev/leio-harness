/**
 * Package-owned invariant companion for `@leio-ai/leio-launch-environment`.
 * @module @leio-ai/leio-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@leio-ai/leio-launch-environment'
