...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@leio-ai/leio-agent-loop`.
- No cross-package deep imports (`@leio-ai/leio-*/src/...` paths) — public entry points only.
