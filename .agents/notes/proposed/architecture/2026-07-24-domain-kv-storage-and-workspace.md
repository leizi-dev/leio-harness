...
| --- | --- | --- | --- |
| `@leio-ai/leio-storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@leio-ai/leio-storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@leio-ai/leio-storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@leio-ai/leio-storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@leio-ai/leio-workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
