...
| 包 | 路径 | ctx 面 | 本期 |
| --- | --- | --- | --- |
| `@leio-ai/leio-storage` | `packages/storage/storage/` | `ctx.storage`（枢纽） | ✓ |
| `@leio-ai/leio-storage-json` | `packages/storage/storage-json/` | 注册后端 `json` | ✓ |
| `@leio-ai/leio-storage-sqlite` | `packages/storage/storage-sqlite/` | 注册后端 `sqlite` | ✓ |
| `@leio-ai/leio-storage-domain` | `packages/storage/storage-domain/` | 挂载 `ctx.storage.domain` | ✓ |
