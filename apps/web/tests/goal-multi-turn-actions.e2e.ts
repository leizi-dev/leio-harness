...
import { parseSessionLog } from '@leio-ai/leio-llm-replay'
import type { SessionEvent, SessionId } from '@leio-ai/leio-session'
import type {} from '@leio-ai/leio-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@leio-ai/leio-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@leio-ai/leio-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@leio-ai/leio-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@leio-ai/leio-skill-filesystem"}\n',
