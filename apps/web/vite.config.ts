...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@leio-ai\/leio-client-web$/, replacement: src('../../packages/client/web/src/boot.tsx') },
      { find: /^@leio-ai\/leio-client-web-react$/, replacement: src('../../packages/client/web-react/src/index.ts') },
      { find: /^@leio-ai\/leio-client-ui-slots$/, replacement: src('../../packages/client/ui-slots/src/index.ts') },
      { find: /^@leio-ai\/leio-client-ui-primitives$/, replacement: src('../../packages/client/ui-primitives/src/index.ts') },
      { find: /^@leio-ai\/leio-client-ui-attachment$/, replacement: src('../../packages/client/ui-attachment/src/index.ts') },
      { find: /^@leio-ai\/leio-client-schema-form$/, replacement: src('../../packages/client/schema-form/src/index.ts') },
      { find: /^@leio-ai\/leio-client-modules\/client$/, replacement: src('../../packages/client/modules/src/client/index.ts') },
    ],
  },
  define: {
