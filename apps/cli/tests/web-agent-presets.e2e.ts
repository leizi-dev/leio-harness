...
import { boot, healProfilesModuleFallback, loadOverlayPatches } from '@leio-ai/leio-app-boot'
import { provideCmdline } from '@leio-ai/leio-cmdline'
import { SessionId } from '@leio-ai/leio-session'
import type { Agent } from '@leio-ai/leio-agent'
import type { PatchOptions } from '@deepseek-ai/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it } from 'vitest'
import { settingsNamespace } from '@leio-ai/leio-settings'
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@leio-ai/leio-agent-presets'
import { applyChildComposition, childSessionMeta } from '@leio-ai/leio-subagent'
import { CallId } from '@leio-ai/leio-llm'
import type {} from '@leio-ai/leio-compaction-basic'
...
import type {} from '@leio-ai/leio-token-meter'
...
describe('product subagent rows in user presets', () => {
  ...
  beforeAll(async () => {
    ...
    productCtx = await bootWeb(settingsFile, [
      { insert: [
        { id: 'subagent-codex', name: '@leio-ai/leio-subagent-codex' },
        { id: 'subagent-claude-code', name: '@leio-ai/leio-subagent-claude-code' },
      ] },
      {
        id: 'agent-presets',
        config: {
