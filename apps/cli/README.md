...
Bundles named in `dsh.profile.bundles` resolve from the dsh installation first (`@leio-ai/leio-base`, `@leio-ai/leio-web-app`, `@leio-ai/leio-headless`), then from the profile's own `node_modules`, where pnpm installs out-of-tree plugins.
