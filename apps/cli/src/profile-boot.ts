 ...
 * @module @leio-ai/leio/profile-boot
 */
...
import { DSH_LAUNCH_ENVIRONMENT_KEY, type LaunchEnvironmentSnapshot } from '@leio-ai/leio-launch-environment'
...
export interface RunProfileOptions {
  ...
  /** Whether to watch user patch files and mount the HMR service after boot. */
