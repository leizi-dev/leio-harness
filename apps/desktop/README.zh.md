...
打包版本在启动十秒后检查带签名的 Gitee 更新清单，通用设置页也提供手动检查、下载和重启安装流程。更新只接受 NSIS 安装包；主进程会在启动替换安装程序前校验清单签名、安装包大小和 SHA-256 摘要。更新通道和签名流程见 [`updates/README.md`](../../updates/README.md)。
